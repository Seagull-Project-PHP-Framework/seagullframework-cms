<form id="page-container" class="columns layout-2cols" method="post" action="<?php if ($this->options['strict'] || (isset($t) && method_exists($t, 'makeUrl'))) echo htmlspecialchars($t->makeUrl("updatePage","page","page"));?>">
        ...
        <div class="layout-inner">
            ...
            <div id="page-panel-tabs">
	            ...
	            <div id="page-panel-content">
                    ...
                    <div class="route-widget-container clearfix" style="width: 100%;">
